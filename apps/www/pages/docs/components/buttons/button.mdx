...
The `Button` component supports multiple colors to match different use cases and design preferences. Below are the available colors:

- **Default**: A standard button for general use.
...
<DocsPreview>
<DocsComp>
<Button color="filled">Hello</Button>
<Button color="tonal">Hello</Button>
<Button color="outlined">Hello</Button>
<Button color="elevated">Hello</Button>
...
<Button shape="square" size="extrasmall">XSmall</Button>
<Button shape="square" size="small">Small</Button>
<Button shape="square" size="medium">Medium</Button>
<Button shape="square" size="large">Large</Button>
<Button shape="square" size="extralarge">XLarge</Button>
